    ...
    <div class="login-box">
      <form class="login-form" action="javascript:void(0)" id="girisform">
        ...
        <div class="form-group">
          ...
          <input class="form-control" type="text" name="kullaniciadi" placeholder="Kullanıcı Adı" value="<?php if ($_COOKIE["kullaniciadi"]) {
                                                                                                            echo htmlspecialchars($_COOKIE["kullaniciadi"]);
                                                                                                          } ?>" autofocus required>
        </div>
        <div class="form-group">
